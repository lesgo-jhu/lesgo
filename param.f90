module param
  ...
  integer,parameter:: nx=64,ny=64,nz=(81-1)/nproc + 1
  ...
  real(rprec),parameter::z_i=1000._rprec
  real(rprec),parameter::L_x=2.*pi*z_i/1000., L_y=L_x, L_z=2.*z_i/nproc
  ...
  real (rprec), parameter :: dt = 5.0e-5
