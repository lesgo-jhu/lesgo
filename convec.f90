...
!       print*, 'A. From convec, jz_abs, RHSz(16,16,jz)', jz_abs, cz(16,16,jz)
       end do
    end if 
...
!       print*, 'B. From convec, jz_abs, RHSz(16,16,jz)', jz_abs, cz(16,16,jz)
!       end do
    end if 
...
! note: cc_big is going into cz!!!!
   call unpadd(cz(:,:,jz),cc_big(:,:,jz))
    ...
    if (jt == 10) then
       ...
       !print*, 'AB. From convec, jz_abs, RHSz(16,16,jz)', jz_abs, cz(16,16,jz)
       !end do
    end if 
...
$endif
    ...
    if (jt == 10) then
       ...
       !print*, 'C. From convec, jz_abs, RHSz(16,16,jz)', jz_abs, cz(16,16,jz)
       end do
    end if 
