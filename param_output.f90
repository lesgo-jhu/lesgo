...
write(2,l_fmt) 'perte_calc : ', perte_calc
write(2,x3i_fmt) 'perte_nstart, perte_nend, perte_nskip : ', perte_nstart, perte_nend, perte_nskip

write(2,l_fmt) 'zpert_calc : ', zpert_calc
write(2,x3i_fmt) 'zpert_nstart, zpert_nend, zpert_nskip : ', zpert_nstart, zpert_nend, zpert_nskip
