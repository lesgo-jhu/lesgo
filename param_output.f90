...
character(*), parameter :: i_fmt = '(a,i6)'
character(*), parameter :: x2i_fmt = '(a,2i6)'
character(*), parameter :: x3i_fmt = '(a,3i6)'
character(*), parameter :: x4i_fmt = '(a,4i6)'

character(*), parameter :: f_fmt = '(a,f12.6)'
character(*), parameter :: x2f_fmt = '(a,2f12.6)'
character(*), parameter :: x3f_fmt = '(a,3f12.6)'

character(*), parameter :: if_fmt='(a,i,f12.6)'
character(*), parameter :: ix3f_fmt='(a,i,3f12.6)'
